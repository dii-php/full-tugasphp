...
<body>
<header>
    <h1>Program Minimarket</h1>
    <p>Oleh: Moh.Novrialdi Pratama, Hanung Pramono, Sayyid, Alief Satrio.</p>
</header>

<div class="container">

<?php
// --- 1. Definisi Data Barang dan Fungsi PHP ---
$daftar_stok = [
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['qty'])) {
    ...
    } elseif ($total_belanja_awal >= 50000) {
